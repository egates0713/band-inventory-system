...
// Google Drive response interface  
...
class GoogleDriveSyncService {
  ...
  private async findInventoryFile(): Promise<GoogleDriveFile | null> {
  ...
  private async createFile(content: string): Promise<GoogleDriveFileResponse> {
    const fileMetadata = {
  ...
  private async updateFile(fileId: string, content: string): Promise<GoogleDriveFileResponse> {
